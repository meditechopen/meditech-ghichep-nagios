...
- [ 2. Cài đặt Nagios Server](#2)
    ...
    - [2.4 Cài đặt NRPE trên Nagios Server](#2.4)
    - [2.5 Khởi động Nagios Server](#2.5)
- [3. Giám sát host/dịch vụ](#3)
    - [3.1 Giám sát host Linux thông qua NRPE](#3.1)
        - [3.1.1 Cài đặt NRPE trên host cần giám sát](#3.1.1)
        - [3.1.2 Thêm thông tin host trên Nagios Server](#3.1.2)
        - [3.1.3 Kiểm tra trên Web UI của Nagios Server](#3.1.3)
...
<a name="2.4"></a>
#### 2.4 Cài đặt NRPE trên Nagios Server
...
<a name="3.1.1"></a>
##### 3.1.1 Cài đặt NRPE trên host cần giám sát
...
<a name="3.1.2"></a>
##### 3.1.2 Thêm thông tin host trên Nagios Server
...
<a name="3.1.3"></a>
#### 3.1.3 Kiểm tra trên Web UI của Nagios Server
