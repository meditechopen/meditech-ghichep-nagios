...
#### IP Planning
Hostname | OS | Service | Interface | IP Address | Netmask |  Gateway | DNS | CPU (Core) | RAM (GB) | DISK (GB) |
--|--|--|--|--|--|--|--|--|--|--|
nagios | CentOS 7 | Nagios | eth0 | 192.168.100.196 | 255.255.255.0 | 192.168.100.1 | 8.8.8.8 | 1 | 1 | 20 |
db-mysql01 | CentOS 7 | MariaDB | eth0 | 192.168.100.197 | 255.255.255.0 | 192.168.100.1 | 8.8.8.8 | 1 | 1 | 20 |
rabbitmq01 | CentOS 7 | RabbitMQ | eth0 | 192.168.100.198 | 255.255.255.0 | 192.168.100.1 | 8.8.8.8 | 1 | 1 | 20 |
web01 | CentOS 7 | httpd | eth0 | 192.168.100.199 | 255.255.255.0 | 192.168.100.1 | 8.8.8.8 | 1 | 1 | 20 |
