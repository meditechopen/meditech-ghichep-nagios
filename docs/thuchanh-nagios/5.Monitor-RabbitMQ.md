...
- [ 2. Các bước tiến hành ](#2)
    ...
    - [ 2.2. Chuẩn bị trên host Nagios Server](#2.2)
    - [ 2.3. Cài đặt Plugin ](#2.3)
    - [ 2.4. Thêm thông tin host và giám sát dịch vụ trên Nagios Server](#2.4)
<a name="1"></a>
...
<a name="2.2"></a>
### 2.2 Chuẩn bị trên host Nagios Server
...
<a name="2.4"></a>
#### 2.4 Thêm thông tin host và giám sát dịch vụ trên Nagios Server
